...
def build_enterprise_executor(executor: Any, workdir: Path) -> Callable[[dict[str, Any]], dict[str, Any]]:
    ...
    def run_enterprise(spec: dict[str, Any]) -> dict[str, Any]:
        from energy_research_agent.automation.contracts import ResearchRequest as AutomationResearchRequest
        from energy_research_agent.automation.enums import ResearchType
