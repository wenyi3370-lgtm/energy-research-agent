...
from energy_research_agent.domain.enums import RunStatus, SourceLevel
from energy_research_agent.domain.ids import new_sortable_id
from energy_research_agent.domain.models import CrossDomainFinding, RunManifest
from energy_research_agent.evidence.freeze import FreezeService
from energy_research_agent.evidence.store import EvidenceStore, canonical_json
...
def publish_unified(
    *,
    ...
    from energy_research_agent.domain.ids import new_sortable_id
    from energy_research_agent.evidence.store import canonical_json
    from energy_research_agent.release.audit import ArtifactConsistencyAuditor
    ...
    if detection_path.is_file():
        try:
            from energy_research_agent.domain.models import ProductDetection
