"""Executor boundary between the automation service and the research kernel.

The executors defined here never perform network I/O.
...
- freeze happens only after CoreValidator passes (enforced by the evidence runner);
