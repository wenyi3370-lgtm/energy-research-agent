...
from energy_research_agent.adapters.base import SearchAdapter, SearchHit, SearchRequest, SearchResultEnvelope
...
from energy_research_agent.domain.enums import EnterpriseComplexity, RunStatus, SourceLevel, VerificationStatus
...
from energy_research_agent.research.client_profile import load_client_profile
from energy_research_agent.research.claim_utilization import ClaimUtilizationAuditor
...
from energy_research_agent.research.fulltext_hydration import (
...
from energy_research_agent.research.pipeline_trace import GapReasonClassifier, GoalPipelineTrace
from energy_research_agent.research.planner import ANALYTICAL_FIELDS, GOAL_FAMILIES, ResearchPlanner
...
from energy_research_agent.research.synthesis import ResearchSynthesizer, write_synthesis
...
"""
    ...
    def _reconcile_catalog(self) -> None:
        from energy_research_agent.research.catalog import CatalogInventory, CatalogTraverser
    ...
    def _catalog_summary(self) -> dict:
        from energy_research_agent.research.catalog import CatalogInventory
    ...
    def _freeze_and_publish(self, store: EvidenceStore, run_id: str, output_dir: Path, conditional: bool = False) -> tuple[str | None, list[str]]:
        ...
        from energy_research_agent.automation.executor import default_publishers
        ...
        from energy_research_agent.validation.formal_publication import FormalPublicationEligibilityValidator
