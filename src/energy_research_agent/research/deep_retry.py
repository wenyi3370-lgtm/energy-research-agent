...
from energy_research_agent.adapters.base import SearchAdapter, SearchRequest
...
from energy_research_agent.domain.models import ExtractedEvidenceBatch, ImageEvidence, ResearchPlan, ResearchQuery, Source
...
from energy_research_agent.agent.models import AgentStrictModel
...
from energy_research_agent.research.requirement_routing import routing_manifest
...
def recover_product_images(
    ...
    *,
    ...
    for url, title in (catalog_pages or []):
        ...
        if existing is None:
            from energy_research_agent.domain.models import Source as _Source
            from energy_research_agent.domain.enums import SourceLevel as _SourceLevel
...
def coverage_audit(
    ...
    *,
    ...
    from energy_research_agent.domain.models import DataFreeze, FrozenResearchBundle, RunManifest
