...
from energy_research_agent.artifacts.publication_terminology import field_label, reason_label
from energy_research_agent.domain.enums import VerificationStatus
from energy_research_agent.domain.models import Claim, DataGap, FrozenResearchBundle
from energy_research_agent.research.publication_relevance import (
    ENERGY_FIELDS,
