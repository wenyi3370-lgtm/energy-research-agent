...
from energy_research_agent.adapters.base import SearchAdapter, SearchRequest, SearchResultEnvelope
from energy_research_agent.domain.models import ResearchPlan
...
class SearchExecutor:
    ...
    def _expected_fields_for(query) -> list[str]:
        ...
        from energy_research_agent.research.contracts import contract_for
