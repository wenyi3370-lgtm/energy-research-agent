...
from enterprise_energy_research.domain.models import utc_now as _utc_now  # reuse domain clock
...
def default_store_path() -> Path:
    from enterprise_energy_research.vendor import repository_root

    override = __import__("os").environ.get("EER_AGENT_DB")
    if override:
