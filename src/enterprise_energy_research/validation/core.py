...
from enterprise_energy_research.domain.enums import Severity, SourceLevel, ValidationStatus, VerificationStatus
from enterprise_energy_research.domain.ids import new_sortable_id
from enterprise_energy_research.domain.models import ValidationFinding, ValidationReport
from enterprise_energy_research.evidence.store import EvidenceStore, EvidenceStoreError


class CoreValidator:
    """Phase 2 structural validator; deeper source/image/render validators arrive in later phases."""
