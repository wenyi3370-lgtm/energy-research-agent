...
<h2>Word 正式交付门</h2><section class="grid"><article class="card"><b>内容深度</b><div class="bar"><span style="width:16.6%"></span></div><p>现有杉杉样稿：2,483 字 / 15,000 字最低线</p><p class="block">反向验收：BLOCKED</p></article><article class="card"><b>结构与密度</b><ul><li>13 个核心章节 + 4 个附录</li><li>每章 4–6 个实质分析段</li><li>标题后、图表前至少 50 字分析</li><li>每个核心章至少一个决策图表</li></ul></article><article class="card"><b>渲染验收</b><ul><li>同名 PDF 必须存在</li><li>默认至少 30 页</li><li>逐页检查 TOC、孤行表题、图题、附录</li><li>短报告须由用户明确要求</li></ul></article></section>
