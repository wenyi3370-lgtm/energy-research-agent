...
python3 ${SKILL_DIR}/scripts/svg_to_pptx.py <project> -a none
...
python3 ${SKILL_DIR}/scripts/svg_to_pptx.py <project> --animation-trigger on-click
...
python3 ${SKILL_DIR}/scripts/svg_to_pptx.py <project> --animation-trigger with-previous
```
...
Executors should wrap logical sections in `<g id>` regardless of whether you plan to animate. The Executor reference (`${SKILL_DIR}/references/shared-standards.md`) requires it.
