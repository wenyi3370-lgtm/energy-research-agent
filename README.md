# Enterprise Energy Research — 企业产业与能源智能调研自动化
...
- 📄 **三件套交付**：Excel 数据总表 + Word 研究报告 + HTML 网页版报告（直发飞书群）
- 📰 **每日情报日报**：每天 10:00 自动采集 V2G/储能/虚拟电厂等情报，按董事长日报格式推送飞书
- ⏰ **定时监测**：watchlist 周期任务自动重跑 + 跨期变化检测
...
| n8n | 5678 | 定时调度（每日情报 10:00 / 监测每小时 / 表单触发） |
...
- **监测每小时**：n8n 工作流 `monitor-schedule-trigger-v1`
