# Fifth-round publication quality contract

This contract supersedes the archived v0.9 length-first rules for formal Word
and unified HTML delivery.
...
- Direct networking is the default. A proxy is process-local and opt-in via
  `EER_OUTBOUND_PROXY`; loopback browser control must bypass it. No source file
